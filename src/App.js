...
function App() {
  ...
  useEffect(() => {
    ...
    if (user.googleId && !products) {
      ...
      getProductsData()
        .then(savedProds => {
          const userPosition = savedProds.indexOf(savedUser => savedUser.id === user.googleId)
          ...
          if (userPosition !== -1) {
            ...
            const defaultProducts = [
              ...
              { name: 'Zapatillas', price: 2000, quantity: 10, period: 'Year', imgUrl: 'https://static0.tiendeo.com.ar/upload_articulos/257825/e3af9bc1-80c2-5be5-8e48-848652227b5f.jpg' },
